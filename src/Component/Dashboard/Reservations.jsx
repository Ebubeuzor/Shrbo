...
const Reservations = () => {
  ...
  const items = [
    {
      key: "1",
      label: <div className=" text-neutral-600  rounded-t-lg">Upcoming</div>,
      children: children1 || empty("4"),
    },
    {
      key: "2",
      label: <div className="text-neutral-600 rounded-t-lg">Completed</div>,
      children: children1 || empty("4"),
    },
    {
      key: "3",
      label: <div className="text-neutral-600  rounded-t-lg">Canceled</div>,
      children: children1 || empty("4"),
    },
    {
      key: "4",
      label: <div className="text-neutral-600  rounded-t-lg">All</div>,
      children: children1 || empty("4"),
    },
  ];
