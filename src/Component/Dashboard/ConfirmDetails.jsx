        ...
        <div className=' p-6 pt-20 flex flex-col md:flex-row  '>
            ...
            <div className=' hidden md:block w-1/2 h-full '>
                            <div className=' p-44 pt-20  ' >
                                <div
                                className="block rounded-lg h-full bg-white  border">
            ...
            <div>
                ...
                <div className=" mx-auto w-full box-border  text-base ">
                 ...
                 <div className=' flex flex-row md:hidden border justify-start gap-1 overflow-hidden text-ellipsis whitespace-nowrap   p-2 w-full  h-16 '>
                        ...
                        <div className='overflow-hidden flex flex-col justify-between text-ellipsis w-[80%]  '>
                            <div className=' text-sm font-semibold'>
                                <span className='   '>la noir en suiteee</span>
                            </div>
                ...
                <ul className=" h-full">
                    <li className="w-full border-b-2  border-opacity-100 py-5 
                        ">
                        <div className=' flex flex-wrap flex-col justify-between gap-2' > 
                                ...
                                <div className=' font-bold  '>
                                    ...
                                    <span
                                        ...
                                        Warning
                                    </span>   Please try again. There was a problem with your account info.
                                    </div>
                                }
                            </div>
                    </li>
