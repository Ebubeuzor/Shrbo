...
const items = [
  ...
  },
  {
    ...
    children: <div className=" text-neutral-600  rounded-t-lg">
    Upcoming 
  </div>,
        ...
        <div className=' flex flex-col gap-4  relative'>
          <div className=' cursor-pointer w-full h-full outline-none    '>
            <div className=' pointer p-6 rounded-2xl border'>
              <div className=' font-medium
               mb-2 mr-1 text-sm '>Per night</div>
              <div className=' h-auto visible w-full '><div className=' text-3xl break-keep inline-block font-extrabold '>$42</div></div>
          ...
          <div className=' rounded-2xl flex border p-6 justify-between gap-3 '>
            <div className=' touch-manipulation relative outline-none h-full w-full cursor-pointer '>
              <div className=' mr-1 text-sm block box-border'>Custom Weekend Price</div>
            </div>
            <div className=' block whitespace-nowrap -my-[10px] '>
              <div className=' relative touch-manipulation cursor-pointer text-center p-[10px] -mx-[10px]'>  <div className=' underline  text-sm block box-border'>Add</div></div>
            </div>
...
{/* 
        ...
        <div className=' cursor-pointer w-full h-full outline-none    '>
          <div className=' pointer p-6 rounded-2xl border'>
            ...
            <div className=' h-auto visible w-full flex justify-between items-baseline'>
              <div className=' text-3xl break-keep inline-block font-extrabold '>10%</div> 
              <div className='  break-keep inline-block text-slate-600 text-sm  '>Weekly average is $265</div></div>
        ...
        <div className=' cursor-pointer w-full h-full outline-none    '>
          <div className=' pointer p-6 rounded-2xl border'>
            ...
            <div className=' h-auto visible w-full flex justify-between items-baseline'>
              <div className=' text-3xl break-keep inline-block font-extrabold '>20%</div> 
              <div className='  break-keep inline-block text-sm text-slate-600  '>Monthly average is $265</div></div>
        ...
        <div className=' rounded-2xl flex border p-6 justify-between items-center gap-3 '>
          <div className=' touch-manipulation relative outline-none h-full w-full cursor-pointer '>
            <div className=' mr-1 text-sm block box-border'>More Dicounts</div>
            <div className=' mr-1 text-sm block box-border'>Early bird ,last-minute,trip length</div>
          </div>
          <div className=' block whitespace-nowrap -my-[10px] '>
            <div className=' relative touch-manipulation cursor-pointer text-center p-[10px] -mx-[10px]'>  <div className='  text-sm block box-border'><IoIosArrowForward/></div></div>
          </div>
