...
export default function CategoryHeader() {
  const categories = [
    { id: "design", label: "Design", image: Homes, link: "/design" },
    { id: "travel", label: "Travel", image: Travel, link: "/travel" },
    { id: "food", label: "Food", image: Food, link: "/food" },
    { id: "Office", label: "Office", image: Office, link: "/guest" },
    { id: "Art", label: "Art", image: Art, link: "/time" },
    { id: "Beach", label: "Beach", image: Beach, link: "/time" },
    { id: "11", label: "Food", image: Food, link: "/food" },
    { id: "12", label: "Office", image: Office, link: "/guest" },
    { id: "13", label: "Art", image: Art, link: "/time" },
    { id: "1", label: "Beach", image: Beach, link: "/time" },
    { id: "4", label: "Food", image: Food, link: "/food" },
    { id: "10", label: "Office", image: Office, link: "/guest" },
    { id: "7", label: "Art", image: Art, link: "/time" },
    { id: "2", label: "Beach", image: Beach, link: "/time" },
    { id: "6", label: "Food", image: Food, link: "/food" },
