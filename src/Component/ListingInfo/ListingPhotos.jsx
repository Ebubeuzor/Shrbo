...
const ListingPhotos = () => {
  ...
  const labels = ["Rating(4.8)", "Reviews(33 reviews)", "Ottawa, Ontario, Canada"];
  ...
  const imageUrls = [kitchen, room, room, kitchen]; // Add more image URLs as needed
      ...
      <div className="md:flex md:flex-row relative mt-5 w-full hidden">
        ...
        <div className="absolute xl:bottom-7 xl:right-8 md:right-6 md:bottom-[10%]">
          <button className="bg-black/80 hover:bg-black/90 p-2 xl:w-36 md:w-32 rounded" onClick={showModal}>
            <div className="flex">
              <span className="mx-1">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="17px" height="17px" fill="#FFFFFF">
