 ...
 const BookingInfo=()=>{
    ...
    return(
        <div>
            ...
            <form>
                      {/* <!--Date--> */}
                   <div className='mx-1 mt whitespace-pre-wrap box-border text-base' >Nov 20 - Dec 20</div>
...
function MyDropdown({
    ...
    const items = [
         ...
         <div key={1} className="flex md:p-8 p-4 gap-2  lg:w-[520px] flex-col space-y-4">
